...
float getVoltage() {
  ...
  // ********   2 x 12v LEAD ACID BATTERIES = 100% = 27.4V - 0% = 23.2V  *********
  float batteryPercentage = ((inputVoltage - 27.4) / (27.4 - 23.2)) * 100.0; // Calculate the percentage using floating-point arithmetic
